...
let
  ...
  fhs-package = stdenv.mkDerivation {
    ...
    installPhase = ''
      ...
      elif [ -f "${antigravity-unwrapped}/lib/antigravity/icon.png" ]; then
        cp ${antigravity-unwrapped}/lib/antigravity/icon.png $out/share/pixmaps/antigravity.png
        cp ${antigravity-unwrapped}/lib/antigravity/icon.png $out/share/icons/hicolor/1024x1024/apps/antigravity.png
      fi
  ...
  no-fhs-package = stdenv.mkDerivation {
    ...
    installPhase = ''
      ...
      elif [ -f "$out/lib/antigravity/icon.png" ]; then
        cp $out/lib/antigravity/icon.png $out/share/pixmaps/antigravity.png
        cp $out/lib/antigravity/icon.png $out/share/icons/hicolor/1024x1024/apps/antigravity.png
      fi
